...
a = Entrypoint('conditioned-profile', 'console_scripts', 'cp-archiver')
...
import os
import os.path
for f in os.listdir("condprof/base_profile"):
    f = "condprof/base_profile/" + f
    print("adding %s" % f)
    a.datas.append((f, f, "DATA"))

for _F in _FILES:
    a.datas.append((_F, _F, "DATA"))
